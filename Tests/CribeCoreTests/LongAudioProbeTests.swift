...
/// `CRIBE_PROBE_WAV` все три пробы пропускаются.
///
/// ```
/// say -v Milena -r 220 -f текст.txt -o длинная.wav --data-format=LEI16@16000 --file-format=WAVE
/// CRIBE_PROBE_WAV=длинная.wav swift test --disable-keychain --filter LongAudioProbeTests
/// ```
///
...
final class LongAudioProbeTests: XCTestCase {
    ...
    static var language: Language {
        Language(rawValue: ProcessInfo.processInfo.environment["CRIBE_PROBE_LANG"] ?? "ru") ?? .ru
    }
