...
public final class UserDictionary: @unchecked Sendable {
    public static let defaultURL: URL = FileManager.default
        ...
        .appendingPathComponent("Cribe/dictionary.json")

    private let url: URL
    private let queue = DispatchQueue(label: "online.nazarovych.cribe.dictionary")
    private let watchQueue = DispatchQueue(label: "online.nazarovych.cribe.dictionary.watch")
