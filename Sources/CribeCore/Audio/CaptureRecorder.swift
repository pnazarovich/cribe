...
public final class CaptureRecorder: NSObject, AudioCapturing, AVCaptureAudioDataOutputSampleBufferDelegate {
    ...
    private let logger = Logger(subsystem: "online.nazarovych.cribe", category: "CaptureRecorder")
    ...
    private let sampleQueue = DispatchQueue(label: "online.nazarovych.cribe.capture")
    ...
    private let sessionQueue = DispatchQueue(label: "online.nazarovych.cribe.capture.session")
